...
board.on("ready", function() {  
  ...
  var air = new five.Sensor("A1");
  var startAirTime = Date.now();
  var airCondition = 0;
  ...
  this.loop(100, function() {
    ...
    //if ((Date.now() - startAirTime) > 180000) {
      airCondition = (25 * air.value / 1023)
      if (airCondition > 400) 
      {
        r = 255; 
        b = 0;
    ...
    var msjTemp = (Math.round(temp.celsius*100)/100)+"C";
    var msjAir = "AC:" + (Math.round(airCondition*100)/100);
    var msjSound = (Math.round(sound.value*100)/100)+"dBs ";
    lcd.bgColor(r, g, b)
      .cursor(0, 0).print(msjTemp +"|=|"+msjAir)
      .cursor(1, 0).print(msjSound);
    console.log(msjTemp+"\n"+msjAir+"\n"+msjSound+"\nR="+r+" G="+g+" B="+b);
